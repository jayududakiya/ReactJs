...
function Footer() {
  return (
    <footer className="footer-wrapper m-auto">
      <div className="container p-10 m-auto">
        ...
        <div className="mb-8 mx-auto grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-7 justify-stretch gap-[3rem]">
          <div className="lg:col-span-2">
            ...
            <p className="poppins-regular pr-[4rem]  text-[#8e8e8e] text-[1.4rem] text-left leading-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-[1.4rem] poppins-semibold underline mb-[2.5rem]">
              Get Newsletter
            </h3>

            <p className="poppins-regular text-[#8e8e8e] text-[1.5rem] text-left mb-8">
            ...
            <div className="footBtn ">
              ...
              />
              <button className="Btn flex items-center justify-center px-2 py-6">
                Subscribe Now
        ...
        <div className="contact-bar flex flex-wrap items-center justify-between ">
          ...
          <div className='contact-box flex items-center mb-6 sm:mb-0'>
            ...
            <span className=' flex items-center text-[3rem] mr-8'>
              <i className="fa-solid fa-phone -rotate-90"></i>
            </span>

            <p className='contact-text'>
              <a href="tel:" className='block poppins-semibold text-[1.4rem] uppercase'>980.029.666.99</a>
              <span className='block  poppins-light text-[1rem]'>Working 8:00-22:00</span>
            </p>
          ...
          <div className='appInfo'>
            <ul className='flex flex-wrap items-center'>
              <li className=' mb-4 sm:mb-0'>
                <h3 className=' poppins-semibold text-[1.8rem]' >Download App on Mobile</h3>
                <p className=' poppins-light text-[1.2rem] text-[#8e8e8e]' >15% discount on your first purchase</p>
              </li>
      ...
      <div className="copyRight-bar">
        ...
        <p className='poppins-regular md:col-span-2  mb-4 sm:mb-0 text-[1.3rem] text-[#8e8e8e]'>
